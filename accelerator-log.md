...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=cgcollab&repo=giant-app",
  "buildTool" : "maven",
  "includeBuildToolWrapper" : true,
  "javaVersion" : "11",
  "nativeBuild" : false,
  "projectName" : "giat-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->giat-app]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=cgcollab&repo=giant-app'
